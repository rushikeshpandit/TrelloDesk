defmodule TrelloDeskWeb.Router do
  ...
  scope "/", TrelloDeskWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{TrelloDeskWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", TrelloDeskWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{TrelloDeskWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", TrelloDeskWeb do
    ...
    live_session :current_user,
      on_mount: [{TrelloDeskWeb.UserAuth, :mount_current_user}] do
